...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -9.6
...
#define DEFAULT_AXIS_STEPS_PER_UNIT  {195,195,7200,90}  // default steps per unit for Ultimaker
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 145,40} // X,Y,Z Axis Extend and Retract angles
