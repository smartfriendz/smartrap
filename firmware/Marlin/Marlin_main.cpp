    ...
    case 29: // G29 Detailed Z-Probe, probes the bed at 3 points.
        {
            ...
            engage_z_probe();   // Engage Z Servo endstop if available
            run_z_probe();
            current_position[Z_AXIS]+=0.6f; // hack smartfriendz . we compensate x axis force bending here.
            ...
            real_z = (float(st_get_position(Z_AXIS))/axis_steps_per_unit[Z_AXIS])+0.6f;  //get the real Z (since the auto bed leveling is already correcting the plane)
